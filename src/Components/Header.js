...
function Header() {
    ...
    return (
      <header className="md:flex justify-between justify-items-center sticky top-0 bg-white dark:bg-zinc-900 py-4">
        <div className="flex items-center justify-between">
          <div className="flex gap-4 items-center">
            <NavLink to="/" className="font-medium text-xl cursor-pointer">
              <text-colored>Nathan Studley</text-colored>
            </NavLink>
            <Link
              className="links"
